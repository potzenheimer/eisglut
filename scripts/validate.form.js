	...
	function validate_form(){
			...
			// Betreff
	        if (document.getElementById("betreff").value =="" || document.getElementById("betreff").value == null){
	            jQuery("#betreff").animate({backgroundColor: "#ff4343"});
	            jQuery("#betreff").parent().find("label").animate({color: "#fff"});
	            error = 1;
	        }	        
	        ...
	        if (error == 1){
	            ...
	            jQuery.ajax({
	                ...
	                success:    function(html) {
	                    ...
	                    jQuery("#contact_form").after("<h3 class='center' id='send_message'>Vielen Dank Wir werden uns umgehend mit Ihrem Anliegen befassen und uns gegebenenfalls bei Ihnen melden Euer EISGLUT-Team</h3>");
